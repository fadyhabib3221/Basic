    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto p-4 md:p-6">
        ...
        {hasAdminAccess && showOnlineList && (
          <div className="hidden 2xl:flex flex-col absolute top-4 md:top-6 left-full ml-6 w-64 max-h-[340px] bg-white border border-stone-200 rounded-2xl p-2 shadow-lg shadow-stone-900/5 overflow-y-auto z-20">
